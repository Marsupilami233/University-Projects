...
int main(int argc, char **argv)
{
    ...
    if (UnitNumber == 4)
    {
	// check replace and duble deletion for duplicate key
	const int ins[] = {10, 10};
	const int del[] = {10, 10}; 
        unitDriver(ins, sizeof ins / sizeof(int),
		   del, sizeof del / sizeof(int));
    ...
    if (UnitNumber == 6)
    {
	// (BRAND NEW DESIGNED) complete deletion and in avl, it keeps removing root (differ from MP5)
	const int ins[] = {200,100,50,150,25,75,125,175,65,85,135,80,130,140,78,82};
	const int del[] = {100,125,130,135,80,82,85,140,150,75,78,175,65,50,200,25}; 
        unitDriver(ins, sizeof ins / sizeof(int),
		   del, sizeof del / sizeof(int));
    }    
    if (UnitNumber == 7)
    {
	// (BRAND NEW ADDED UNIT) ONE deletion can cause TWO rotations!
	const int ins[] = {26,16,52,6,22,36,58,4,12,18,24,30,46,54,62,2,8,14,20,28,34,42,48,56,60,64,10,32,40,44,50,66,38};
	const int del[] = {26}; 
        unitDriver(ins, sizeof ins / sizeof(int),
		   del, sizeof del / sizeof(int));
    }      
