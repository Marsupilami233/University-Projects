...
-- ***************************************************************************
-- Generated on "10/11/2019 15:53:04"
                                                            
-- Vhdl Test Bench template for design  :  airplane_CL
-- 
...
ENTITY airplane_vhd_tst_2 IS
END airplane_vhd_tst_2;
ARCHITECTURE airplane_arch OF airplane_vhd_tst_2 IS
-- constants                                                 
-- signals                                                   
...
BEGIN 
   reset <= '0'; 
	...
	wait for 10ns; smooth <= '1';   -- test that the seat belt went well in specific situations, and will bot go down
        ...
        ivalid <= '0';                  -- To see if the state will have some unwanted transition
	...
	wait for 10ns; alt_10k <= '1';
        ...
        ivalid <= '1';                  -- The state will be changing at this point
	...
	wait for 10ns; alt_25k <= '1';
        ...
        ivalid <= '0';                  -- the state will not suppose to change to this point, it should stay at the 10k~25k range 
	...
	wait for 10ns; smooth <= '1'; -- smooth for five cycle
        ...
        ivalid <= '1';                  -- the state will start to change from 10k~25K to above 25k
 
	wait for 10ns; alt_25k <= '1';
	wait for 10ns; alt_25k <= '0';-- the plane should go above_25k
	wait for 10ns; alt_10k <= '1';
	wait for 10ns; alt_10k <= '0';-- the plane should stay on the state of above_25k and go to the smooth_count1->count5
