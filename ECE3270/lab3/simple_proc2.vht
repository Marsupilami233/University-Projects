...
ENTITY simple_proc_vhd_tst2   IS
END simple_proc_vhd_tst2;
ARCHITECTURE simple_proc_arch OF simple_proc_vhd_tst2  IS
-- constants                                                 
-- signals                                                   
...
BEGIN                                                         
   ...
   rstn <= '0';
	run <= '0';
	DIN <= "1111111101000000";  --mv 0,DIN 11111111_01000000  R0 : 11110000
	wait for 10ns;
	run <= '1';
	rstn <= '1';
	wait for 10ns;
	run <= '0';
	wait for 10ns; -- wait for the state to go back to zero
   ...
   DIN <= "0000000010000001";  --add 0,1  make it overflow
   run <= '1';
   wait for 10ns;
   run <= '0';
	wait for 40ns;	
